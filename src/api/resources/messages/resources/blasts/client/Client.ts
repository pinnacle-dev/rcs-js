...
export class Blasts {
     ...
     *
     * @param {Pinnacle.messages.ListBlastsParams} request
    ...
    ): core.HttpResponsePromise<Pinnacle.ListBlastsResponse> {
    ...
    private async __list(
        request: Pinnacle.messages.ListBlastsParams = {},
        requestOptions?: Blasts.RequestOptions,
    ): Promise<core.WithRawResponse<Pinnacle.ListBlastsResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Pinnacle.ListBlastsResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.PinnacleTimeoutError("Timeout exceeded when calling POST /messages/blasts/list.");
            case "unknown":
                throw new errors.PinnacleError({
