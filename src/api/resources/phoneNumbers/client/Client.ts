...
export class PhoneNumbers {
    ...
    public list(
        ...
        requestOptions?: PhoneNumbers.RequestOptions,
    ): core.HttpResponsePromise<Pinnacle.ListPhoneNumbersResponse> {
    ...
    private async __list(
        request: Pinnacle.ListPhoneNumbersParams = {},
        requestOptions?: PhoneNumbers.RequestOptions,
    ): Promise<core.WithRawResponse<Pinnacle.ListPhoneNumbersResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({ ...(await this._getCustomAuthorizationHeaders()) }),
            requestOptions?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as Pinnacle.ListPhoneNumbersResponse, rawResponse: _response.rawResponse };
        }
