...
export class Brands {
    ...
    public list(
        ...
        requestOptions?: Brands.RequestOptions,
    ): core.HttpResponsePromise<Pinnacle.ListBrandsResponse> {
    ...
    private async __list(
        request: Pinnacle.ListBrandsParams = {},
        requestOptions?: Brands.RequestOptions,
    ): Promise<core.WithRawResponse<Pinnacle.ListBrandsResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({ ...(await this._getCustomAuthorizationHeaders()) }),
            requestOptions?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as Pinnacle.ListBrandsResponse, rawResponse: _response.rawResponse };
        }
