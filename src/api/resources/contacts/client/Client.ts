...
export class Contacts {
     ...
     *
     * @param {Pinnacle.ListContactsParams} request
     * @param {Contacts.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Pinnacle.BadRequestError}
     * @throws {@link Pinnacle.UnauthorizedError}
    ...
    public list(
        ...
        requestOptions?: Contacts.RequestOptions,
    ): core.HttpResponsePromise<Pinnacle.ListContactsResponse> {
    ...
    private async __list(
        request: Pinnacle.ListContactsParams = {},
        requestOptions?: Contacts.RequestOptions,
    ): Promise<core.WithRawResponse<Pinnacle.ListContactsResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({ ...(await this._getCustomAuthorizationHeaders()) }),
            requestOptions?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as Pinnacle.ListContactsResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.PinnacleTimeoutError("Timeout exceeded when calling POST /contacts/list.");
            case "unknown":
                throw new errors.PinnacleError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
