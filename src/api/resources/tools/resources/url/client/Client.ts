...
export class Url {
     ...
     *
     * @param {Pinnacle.tools.ListLinksParams} request
     * @param {Url.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Pinnacle.BadRequestError}
     * @throws {@link Pinnacle.UnauthorizedError}
    ...
    public list(
        ...
        requestOptions?: Url.RequestOptions,
    ): core.HttpResponsePromise<Pinnacle.ListLinksResponse> {
    ...
    private async __list(
        request: Pinnacle.tools.ListLinksParams = {},
        requestOptions?: Url.RequestOptions,
    ): Promise<core.WithRawResponse<Pinnacle.ListLinksResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({ ...(await this._getCustomAuthorizationHeaders()) }),
            requestOptions?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as Pinnacle.ListLinksResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.PinnacleTimeoutError("Timeout exceeded when calling POST /tools/url/list.");
            case "unknown":
                throw new errors.PinnacleError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
