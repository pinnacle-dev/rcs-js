...
export class TollFree {
    ...
    public list(
        ...
        requestOptions?: TollFree.RequestOptions,
    ): core.HttpResponsePromise<Pinnacle.ListTollFreeCampaignsResponse> {
    ...
    private async __list(
        request: Pinnacle.campaigns.ListTollFreeCampaignsParams = {},
        requestOptions?: TollFree.RequestOptions,
    ): Promise<core.WithRawResponse<Pinnacle.ListTollFreeCampaignsResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({ ...(await this._getCustomAuthorizationHeaders()) }),
            requestOptions?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as Pinnacle.ListTollFreeCampaignsResponse,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.PinnacleTimeoutError("Timeout exceeded when calling POST /campaigns/toll-free/list.");
            case "unknown":
                throw new errors.PinnacleError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
