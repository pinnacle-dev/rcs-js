 ...
 *     }
 */
export interface UpsertRcsSchema {
    /** Create an agent for the campaign. */
    agent?: UpsertRcsSchema.Agent;
    ...
    links?: UpsertRcsSchema.Links;
    /** Opt-in configuration. */
    optIn?: UpsertRcsSchema.OptIn;
    /** Opt-out configuration. */
    optOut?: UpsertRcsSchema.OptOut;
    /** Use case classification for the campaign. */
    useCase?: UpsertRcsSchema.UseCase;
}

export namespace UpsertRcsSchema {
    /**
     * Create an agent for the campaign.
     */
