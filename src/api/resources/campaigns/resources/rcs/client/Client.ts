...
export class Rcs {
    ...
    public list(
        ...
        requestOptions?: Rcs.RequestOptions,
    ): core.HttpResponsePromise<Pinnacle.ListRcsCampaignsResponse> {
    ...
    private async __list(
        request: Pinnacle.campaigns.ListRcsCampaignsParams = {},
        requestOptions?: Rcs.RequestOptions,
    ): Promise<core.WithRawResponse<Pinnacle.ListRcsCampaignsResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({ ...(await this._getCustomAuthorizationHeaders()) }),
            requestOptions?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as Pinnacle.ListRcsCampaignsResponse, rawResponse: _response.rawResponse };
        }
