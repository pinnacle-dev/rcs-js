...
export class Dlc {
    ...
    public list(
        ...
        requestOptions?: Dlc.RequestOptions,
    ): core.HttpResponsePromise<Pinnacle.ListDlcCampaignsResponse> {
    ...
    private async __list(
        request: Pinnacle.campaigns.ListDlcCampaignsParams = {},
        requestOptions?: Dlc.RequestOptions,
    ): Promise<core.WithRawResponse<Pinnacle.ListDlcCampaignsResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({ ...(await this._getCustomAuthorizationHeaders()) }),
            requestOptions?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as Pinnacle.ListDlcCampaignsResponse, rawResponse: _response.rawResponse };
        }
