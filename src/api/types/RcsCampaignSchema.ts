...
export interface RcsCampaignSchema {
    /** Agent configured to the campaign. */
    agent?: RcsCampaignSchema.Agent;
    /** Unique identifier for the campaign. */
    campaignId?: number;
    /** List of what the agent might say to users. */
    expectedAgentResponse?: string[];
    /** Legal documentation links. */
    links?: RcsCampaignSchema.Links;
    /** Opt-in configuration. */
    optIn?: RcsCampaignSchema.OptIn;
    /** Opt-out configuration. */
    optOut?: RcsCampaignSchema.OptOut;
    /** Use case classification for the campaign. */
    useCase?: RcsCampaignSchema.UseCase;
}

export namespace RcsCampaignSchema {
    /**
     * Agent configured to the campaign.
     */
