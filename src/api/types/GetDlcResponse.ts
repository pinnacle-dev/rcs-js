...
export interface GetDlcResponse {
    ...
    keywords?: GetDlcResponse.Keywords;
    /** Legal documentation links. */
    links?: GetDlcResponse.Links;
    /** Describe the flow of how users will opt in to this campaign. */
    messageFlow?: string;
    /** Display name of the campaign. */
    name?: string;
    /** Campaign configuration options. */
    options?: GetDlcResponse.Options;
    /** Example messages for the campaign. */
    sampleMessages?: string[];
    /** Use case for the campaign. */
    useCase?: GetDlcResponse.UseCase;
}

export namespace GetDlcResponse {
    /**
     * Keyword response configuration.
     */
