...
/**
 * Response for DLC campaign creation or update.
 */
export interface UpsertDlcResponse {
    ...
    keywords?: UpsertDlcResponse.Keywords;
    /** Legal documentation links. */
    links?: UpsertDlcResponse.Links;
    /** Describe the flow of how users will opt in to this campaign. */
    messageFlow?: string;
    /** Display name of the campaign. */
    name?: string;
    /** Campaign configuration options. */
    options?: UpsertDlcResponse.Options;
    /** Example messages for the campaign. */
    sampleMessages?: string[];
    /** Use case for the campaign. */
    useCase?: UpsertDlcResponse.UseCase;
}

export namespace UpsertDlcResponse {
    /**
     * Keyword response configuration.
     */
